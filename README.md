...
│
├── apps/                         53 built-in applications (.tsx)
...
| 10 — Mobile PWA | (removed) | The mobile edition has been removed from this repository. |
