...
export const PROVIDER_PRESETS: Omit<AIProvider, 'apiKey' | 'enabled'>[] = [
  ...
  },
  {
    ...
    type: 'openai-compatible',
    // Dedicated GLM Coding Plan endpoint (distinct from the pay-as-you-go
    // /api/paas/v4 path). Verified: model IDs are bare slugs (glm-4.6 …),
    // Bearer auth, full OpenAI chat-completions + streaming + tool-calling.
