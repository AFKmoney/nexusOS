...
import DesktopComponent from '../../apps/ScreenshotTool';

export default function MobileScreenshotToolApp({ onBack }: MobileAppProps) {
  return (
    <div className="h-full flex flex-col bg-black text-white overflow-hidden">
      <div className="flex items-center gap-3 px-4 py-3 shrink-0 bg-[#080808] border-b border-white/5 z-50 relative">
        ...
        <h1 className="text-white font-semibold text-[16px]">Screenshot</h1>
      </div>
